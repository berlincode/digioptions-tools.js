...
(function (root, factory) {
  ...
  return {
    ...
    getProvider: function(Web3, data_network){
      if (data_network.providerType === 'HttpProvider'){
        return new Web3.providers.HttpProvider(data_network.provider);
      }
      else if (data_network.providerType === 'WebsocketProvider'){
        return new Web3.providers.WebsocketProvider(data_network.provider);
      }
      throw 'unknown providerType: ' + data_network.providerType;
    }
  };
}));
